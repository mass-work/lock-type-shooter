...
Aim with a mouse or trackball, click to lock a target, then type the displayed Japanese word in romaji to shoot it down. Multiple valid romaji patterns are supported.
...
- `src/game/typingConfig.js` keeps the Japanese word pool, romaji variants, and word-length pacing.
